...
namespace PingMeChat.CMS.EntityFrameworkCore.EntityFrameworkCore
{
    public class AppDBContext : DbContext
    {
        ...
        // feature
        DbSet<BidaTable> BidaTables { get; set; }
        DbSet<DailyReport> DailyReports { get; set; }
        DbSet<Order> Orders { get; set; }
        DbSet<Product> Products { get; set; }
        DbSet<Voucher> Vouchers { get; set; }
        DbSet<BidaTableSession> BidaTableSessions { get; set; }
        DbSet<ServiceSession> ServiceSessions { get; set; }
        DbSet<BidaTableType> BidaTableTypes { get; set; }
        DbSet<Inventory> Inventories { get; set; }
        DbSet<InventoryExport> InventoryExports { get; set; }
        DbSet<InventoryImport> InventoryImports { get; set; }
