...
namespace PingMeChat.CMS.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20240928040942_contact-add-status-field")]
    partial class contactaddstatusfield
    {
            ...
            modelBuilder.Entity("PingMeChat.CMS.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(529),
                            Icon = "fa fa-home",
                            IsActive = true,
                            IsDeleted = false,
                            MenuType = false,
                            ...
                            UpdatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(543),
                            Url = "/home"
                        },
                        new
                        {
                            Id = "fa6f5f76-2266-4f57-8962-258fc43619dd",
                            CreatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(702),
                            Icon = "fas fa-list-ul",
                            IsActive = true,
                            IsDeleted = false,
                            MenuType = true,
                            SortOrder = 2,
                            Title = "Danh mục",
                            UpdatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(703),
                            Url = ""
                        },
                        new
                        {
                            Id = "d4e5f6g7-h8i9-4j0k-1l2m-3n4o5p6q7r8s",
                            CreatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(710),
                            ...
                            SortOrder = 15,
                            Title = "Báo cáo",
                            UpdatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(712),
                            Url = "/report"
                        },
                        new
                        {
                            Id = "e5f6g7h8-i9j0-4k1l-2m3n-4o5p6q7r8s9t",
                            CreatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(718),
                            Icon = "fa fa-id-card",
                            IsActive = true,
                            IsDeleted = false,
                            MenuType = true,
                            SortOrder = 16,
                            Title = "Quản trị",
                            UpdatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(719),
                            Url = ""
                        },
                        new
                        {
                            Id = "f6g7h8i9-j0k1-4l2m-3n4o-5p6q7r8s9t0u",
                            CreatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(726),
                            Icon = "fas fa-user",
                            IsActive = true,
                            IsDeleted = false,
                            MenuType = false,
                            ...
                            SortOrder = 17,
                            Title = "Tài khoản",
                            UpdatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(726),
                            Url = "/user"
                        },
                        new
                        {
                            Id = "g7h8i9j0-k1l2-4m3n-4o5p-6q7r8s9t0u1v",
                            CreatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(733),
                            ...
                            SortOrder = 18,
                            Title = "Phân quyền",
                            UpdatedDate = new DateTime(2024, 9, 28, 11, 9, 42, 227, DateTimeKind.Local).AddTicks(734),
                            Url = "/role"
                        });
                });
